...
//         {/* Pricing Hero */}
//         <section className="py-20 px-4 md:px-10 lg:px-40 text-center">
...
//                 <button className={`w-full h-12 rounded-lg font-bold text-sm mb-8 transition-colors
//                   ${tier.highlight 
...
//         {/* FAQ CTA */}
//         <section className="py-12 bg-white dark:bg-[#0d141b] border-t border-slate-100 dark:border-slate-800 text-center">
//             <p className="text-slate-600 dark:text-slate-400 mb-4">Have specific questions about enterprise needs?</p>
//             <button className="text-[#137fec] font-bold hover:underline">Contact our sales team &rarr;</button>
//         </section>
//       </main>
