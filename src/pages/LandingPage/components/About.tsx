...
export default function About() {
  ...
  const team = [
    { name: "Sarah Jenkins", role: "CEO & Co-Founder", img: "https://lh3.googleusercontent.com/aida-public/AB6AXuDff29x-TS0_lYF0CNs0yFtrzRokMY7u05nsCXZXNeuQ14tpBK5qZgeVOEHZh51veUKoCG__c96QtN3AO-L6PzGMAMBVajGgF5Psq41ecqUrLopLvUj2jCSNz0KWpwFYFy_QYHn6cdmaRgA0JJi-uR7y9LfoVB2j25GlD5tYiweXchNSKWEWOc5D3WPzOy-OqbDNMbF0Lp2jjPSli4kT9BoGCtukt6RFrrU_GiWewPlQzw6lh4SdM3M0gHg7x0wma0gBzn61Q9o04U" },
    { name: "David Chen", role: "CTO", img: "https://lh3.googleusercontent.com/aida-public/AB6AXuDff29x-TS0_lYF0CNs0yFtrzRokMY7u05nsCXZXNeuQ14tpBK5qZgeVOEHZh51veUKoCG__c96QtN3AO-L6PzGMAMBVajGgF5Psq41ecqUrLopLvUj2jCSNz0KWpwFYFy_QYHn6cdmaRgA0JJi-uR7y9LfoVB2j25GlD5tYiweXchNSKWEWOc5D3WPzOy-OqbDNMbF0Lp2jjPSli4kT9BoGCtukt6RFrrU_GiWewPlQzw6lh4SdM3M0gHg7x0wma0gBzn61Q9o04U" },
    { name: "Amara Okeke", role: "Head of Product", img: "https://lh3.googleusercontent.com/aida-public/AB6AXuDff29x-TS0_lYF0CNs0yFtrzRokMY7u05nsCXZXNeuQ14tpBK5qZgeVOEHZh51veUKoCG__c96QtN3AO-L6PzGMAMBVajGgF5Psq41ecqUrLopLvUj2jCSNz0KWpwFYFy_QYHn6cdmaRgA0JJi-uR7y9LfoVB2j25GlD5tYiweXchNSKWEWOc5D3WPzOy-OqbDNMbF0Lp2jjPSli4kT9BoGCtukt6RFrrU_GiWewPlQzw6lh4SdM3M0gHg7x0wma0gBzn61Q9o04U" },
    { name: "Marcus Reid", role: "Lead Designer", img: "https://lh3.googleusercontent.com/aida-public/AB6AXuDff29x-TS0_lYF0CNs0yFtrzRokMY7u05nsCXZXNeuQ14tpBK5qZgeVOEHZh51veUKoCG__c96QtN3AO-L6PzGMAMBVajGgF5Psq41ecqUrLopLvUj2jCSNz0KWpwFYFy_QYHn6cdmaRgA0JJi-uR7y9LfoVB2j25GlD5tYiweXchNSKWEWOc5D3WPzOy-OqbDNMbF0Lp2jjPSli4kT9BoGCtukt6RFrrU_GiWewPlQzw6lh4SdM3M0gHg7x0wma0gBzn61Q9o04U" },
  ];
  ...
  return (
    <div className="bg-[#f6f7f8] overflow-x-hidden min-h-screen flex flex-col">
      ...
      <main className="flex-grow mt-10">
        ...
        {/* Story & Stats Grid */}
        <section className="py-20 px-4 md:px-10 lg:px-40 bg-[#f6f7f8] dark:bg-[#101922]">
          <div className="max-w-[1200px] mx-auto flex flex-col lg:flex-row gap-16 items-center">
            ...
            <div className="flex-1 w-full">
              <div className="grid grid-cols-2 gap-4">
                {stats.map((stat, idx) => (
                  <div key={idx} className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 text-center hover:-translate-y-1 transition-transform duration-300">
        ...
        {/* Values Section */}
        <section className="py-20 px-4 md:px-10 lg:px-40 bg-white dark:bg-[#0d141b]">
           <div className="max-w-[1200px] mx-auto">
             <div className="text-center mb-16">
               <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">What Drives Us</h2>
               <p className="text-slate-600 dark:text-slate-400">The core principles that guide every feature we build.</p>
             </div>
             <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
               {values.map((val, idx) => (
                 <div key={idx} className="flex gap-6 items-start p-8 rounded-2xl bg-slate-50 dark:bg-slate-800/50 hover:bg-white dark:hover:bg-slate-800 border border-transparent hover:border-slate-200 dark:hover:border-slate-700 hover:shadow-xl transition-all duration-300 group">
                   <div className="text-slate-400 group-hover:text-[#137fec] transition-colors bg-white dark:bg-slate-900 p-3 rounded-xl shadow-sm">
                     {val.icon}
                   </div>
                   <div>
        ...
        <section className="py-20 px-4 md:px-10 lg:px-40 bg-[#f6f7f8] dark:bg-[#101922]">
          <div className="max-w-[1200px] mx-auto">
             <div className="text-center mb-16">
               <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">Meet the Builders</h2>
               <p className="text-slate-600 dark:text-slate-400">A remote-first team distributed across 12 timezones.</p>
             </div>
             <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
               {team.map((member, idx) => (
                 <div key={idx} className="flex flex-col items-center bg-white dark:bg-slate-800 rounded-2xl p-6 border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-lg transition-shadow">
                   ...
                   <div className="flex gap-3">
                     ...
                     <button className="text-slate-400 hover:text-slate-600 dark:hover:text-white transition-colors"><PublicIcon /></button>
                   </div>
                 </div>
               ))}
             </div>
