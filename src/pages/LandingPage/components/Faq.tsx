  ...
  const faqs = [
    {
      ...
      a: "Yes! SahajInsights supports secure tunneling to local PostgreSQL, MySQL, and SQL Server databases. You can also upload static exports (CSV, Excel) if you prefer not to open a connection."
    },
    {
      q: "Is my data secure?",
