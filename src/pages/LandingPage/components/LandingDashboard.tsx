          ...
          <div className="max-w-4xl">
            ...
            <div className="pl-32 max-w-[700%]">
              <p className="text-[#8E8E8E] text-[15px] leading-7">
                ...
                charts, tables, and metrics. Easily resize elements, drag and
                drop components, save multiple custom views, and export or share
                your insights with others. Ideal for business analytics,
                inventory tracking, sales insights, marketing performance, and
