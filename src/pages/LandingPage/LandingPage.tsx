  ...
  return (
    <div className="bg-[#f6f7f8] dark:bg-[#101922] font-sans text-slate-900 dark:text-white overflow-x-hidden min-h-screen flex flex-col">
      ...
      <main className="flex flex-col min-h-screen">
        ...
        {/* Timeline Section */}
        <section className="pb-20 bg-[#f6f7f8] dark:bg-[#101922]">
          <div className="px-4 md:px-10 lg:px-40 flex justify-center">
            <div className="w-full max-w-[960px]">
              ...
              <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-center mb-16 group">
                ...
                <div className="flex-1 order-3 md:order-3 text-center md:text-left pt-0 md:pt-8">
                  ...
                  <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-lg">
                    Upload CSVs, Excel files, or connect directly to Google
                    Sheets and databases. We automatically detect types and
                    formats.
                  </p>
              ...
              <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-center mb-16 group">
                <div className="flex-1 order-2 md:order-1 flex justify-end">
                  <div className="relative w-full max-w-md aspect-[4/3] bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 p-6 flex items-center justify-center overflow-hidden transition-transform duration-500 group-hover:scale-[1.02]">
                    <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,_var(--tw-gradient-stops))] from-blue-50 to-transparent dark:from-slate-800/50"></div>
                    <div className="grid grid-cols-2 gap-4 w-full h-full">
                      <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg flex items-end justify-center p-2 gap-1">
                      ...
                      <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg flex items-center justify-center">
                ...
                <div className="flex-1 order-3 md:order-3 text-center md:text-left pt-0 md:pt-8">
                  ...
                  <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-lg">
                    Drag and drop columns to create bar charts, line graphs, and
                    KPIs. Customize colors and labels with ease.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-center group">
                <div className="flex-1 order-3 md:order-1 text-center md:text-right pt-0 md:pt-8">
                  ...
                  <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-lg">
                    Send a public link or embed your dashboard into your own
                    website. Collaborate with your team in real-time.
                  </p>
                </div>
                {/* Timeline Line */}
                <div className="hidden md:flex flex-col items-center self-stretch order-1 md:order-2 w-12 relative">
                ...
                <div className="flex-1 order-2 md:order-3">
                  <div className="relative w-full max-w-md aspect-[4/3] bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 p-6 flex flex-col items-center justify-center overflow-hidden transition-transform duration-500 group-hover:scale-[1.02]">
                    ...
                    <div className="bg-slate-50 dark:bg-slate-900 rounded-lg p-4 border border-slate-200 dark:border-slate-700 w-full max-w-[240px] shadow-sm mb-4">
                      ...
                      <button className="w-full bg-[#137fec] text-white text-xs font-bold py-2 rounded">
                        Copy Public Link
                      </button>
                    </div>
                    <div className="text-slate-400 dark:text-slate-500 flex items-center gap-2 text-sm">
                      ...
                      <span>Live on InsightGrid.io/u/josh</span>
                    </div>
                  </div>
                </div>
              </div>
