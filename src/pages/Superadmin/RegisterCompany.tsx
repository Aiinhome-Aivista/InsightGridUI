...
const RegisterCompany = () => {
    ...
    useEffect(() => {
        ...
        // 🛑 already set হলে আবার set করবে না
        ...
        formik.setValues({
            id: company.id,
            created_by: company.created_by || "",   // ✅ MUST
    ...
    `}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        {/* Company Email */}
                        <div>
                            <label className="text-sm font-medium">Company Email <span className="text-red-500">*</span></label>
                            <div className="relative">
                        ...
                        {/* Area */}
                        <div>
                            <label className="text-sm font-medium">Area / Street <span className="text-red-500">*</span></label>
                            <div className="relative">
                        ...
                        {/* Subscription */}
                        <div>
                            <label className="text-sm font-medium">Subscription Type <span className="text-red-500">*</span></label>
                            <select
