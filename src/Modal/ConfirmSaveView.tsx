...
export default function ConfirmSaveView({
  ...
  return (
    <div className="fixed inset-0 bg-black/30 backdrop-blur-sm z-50 flex items-center justify-center">
      <div className="w-[550px] bg-[#D9D9D9] rounded-2xl shadow-lg flex flex-col justify-center items-center gap-6 p-8">
        ...
        <div className="flex gap-4">
          <button
            className="px-6 py-2 rounded-lg border border-gray-400 text-[#888585] hover:bg-[#4B1AE7] transition"
            onClick={onCancel}
          >
            Cancel
          </button>
